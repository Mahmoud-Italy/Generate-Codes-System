...
<?php endif; ?>         
          ...
          <?php echo $__env->make('system.services.create', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          
            <?php if(count($data) || isset($_GET['search'])): ?>
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <strong>All Data ( <?php echo e(count($data)); ?> )</strong>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="col-sm-12">
                        ...
                        <?php echo Form::Open(['method'=>'GET']); ?>
                           ...
                           <div class="inner-addon right-addon search-addon">
                                ...
                                <a href="<?php echo e(url('services/'.$scopeid)); ?>" >
                                ...
                                <input type="text" name="search" style="margin-bottom: 10px" class="col-sm-6 form-control search-inpo" placeholder="Search for Service Name" value="<?php echo e(isset($_GET['search']) ? $_GET['search'] : ''); ?>">
                            </div>
                          <?php echo Form::Close(); ?>
                        ...
                        <?php if(count($data)): ?>
                          <table class="table table-responsive-sm table-bordered">
                            <thead>
                              ...
                              <th class="text-center" style="width:20%">Service Name</th>
                              <th class="text-center" style="width:10%">Digit</th>
                          ...
                          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                              <tr>
                                ...
                                <td class="text-center"><?php echo e($row->digit); ?></td>
                                <td class="text-center"><?php echo e($row->sort); ?></td>
                                <td class="text-center"><?php echo e(explode(' ',$row->created_at)[0]); ?></td>
                                <td class="text-center"><?php echo App\Service::displayStatus($row->id); ?></td>
                                <td class="text-center">
                                  <?php echo Form::Open(['url'=>'services/destroy/'.$row->id]); ?>

                                    <a href="<?php echo e(url('services/edit/'.$row->id)); ?>" class="btn btn-success">
