...
@endif         
          ...
          @include('system.services.create')
          
            @if(count($data) || isset($_GET['search']))
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <strong>All Data ( {{count($data)}} )</strong>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="col-sm-12">
                        ...
                        {!! Form::Open(['method'=>'GET']) !!}
                           <div class="inner-addon right-addon search-addon">
                                ...
                                <input type="text" name="search" style="margin-bottom: 10px" class="col-sm-6 form-control search-inpo" placeholder="Search for Service Name" value="{{isset($_GET['search']) ? $_GET['search'] : ''}}">
                            </div>
                          {!! Form::Close() !!}
                        ...
                        @if(count($data))
                          ...
                          @foreach($data as $key => $row)    
                              <tr>
                                ...
                                <td class="text-center">{!! App\Service::displayStatus($row->id) !!}</td>
                                <td class="text-center">
                                  {!! Form::Open(['url'=>'services/destroy/'.$row->id]) !!}
                                    <a href="{{ url('services/edit/'.$row->id) }}" class="btn btn-success">
